...
import { NotFoundResponseDto, ServerErrorResponseDto } from 'libs/interceptor/error-response';
...
export class CategoryController {
  ...
  @ApiResponse({ status: 201, description: 'Category created successfully', type: CreatedCategoryResponseDto })
  ...
  findAll(@Query('title') title?: string) {
    return this.categoryService.findAll({ title });
  }

  // ===== GET CATEGORY BY ID =====
  @Serialize(CategoryByIdResponseDto)
  @Get(':id')
  @ApiResponse({ status: 200, description: 'Category by ID', type: CategoryByIdResponseDto })
  @ApiResponse({ status: 404, description: 'Category not found', type: NotFoundResponseDto })
  @ApiResponse({ status: 500, description: 'Internal Server Error', type: ServerErrorResponseDto })
  ...
  @Patch(':id')
  @ApiResponse({ status: 200, description: 'Update category by ID', type: UpdatedCategoryResponseDto })
  @ApiResponse({ status: 404, description: 'Category not found', type: NotFoundResponseDto })
  @ApiResponse({ status: 500, description: 'Internal Server Error', type: ServerErrorResponseDto })
  ...
  @Delete(':id')
  @ApiResponse({ status: 200, description: 'Soft delete category by ID', type: DeletedCategoryResponseDto })
  @ApiResponse({ status: 404, description: 'Category not found', type: NotFoundResponseDto })
  @ApiResponse({ status: 500, description: 'Internal Server Error', type: ServerErrorResponseDto })
